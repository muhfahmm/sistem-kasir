-- =====================================================
-- DATABASE SCHEMA V2.0 - SISTEM KASIR
-- Update: 13 Januari 2026
-- Fitur: Multiple Roles Support
-- =====================================================

CREATE DATABASE IF NOT EXISTS db_kasir;
USE db_kasir;

-- Tabel Users (Pengguna) - UPDATED untuk Multiple Roles
CREATE TABLE users (
...
-- CATATAN PENTING
-- =====================================================
-- File ini adalah versi BARU dengan support Multiple Roles
-- Untuk database existing, gunakan file: database_migration_multiple_roles.sql
-- 
-- Perbedaan dengan database.sql (v1.0):
-- - Kolom 'role' di tabel users: ENUM → VARCHAR(50)
-- - Tambah user dummy 'superuser' dengan role 'admin,kasir'
-- 
-- Cara Install Fresh:
-- 1. Drop database lama (jika ada): DROP DATABASE IF EXISTS db_kasir;
-- 2. Jalankan file ini: mysql -u root -p < database_v2_multiple_roles.sql
-- 
-- Cara Migrate dari v1.0:
-- 1. Gunakan file: database_migration_multiple_roles.sql
-- =====================================================

SELECT 'Database v2.0 created successfully with Multiple Roles support!' as status;
